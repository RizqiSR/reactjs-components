...
export default function App() {
  ...
  return (
    <>
      ...
      <Main animes={animes} onSelectedAnime={handleSelectedAnime} selectedAnime={selectedAnime} />
    </>
  );
}
...
function SearchResultNum({animes}) {
  return (
...
function Main({animes, onSelectedAnime, selectedAnime}) {
    return (
    <main className="main">
